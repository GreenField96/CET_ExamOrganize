...
if(isset($_GET["delivery_id"])){
  ...
  WHERE 
  answer_paper_movement.id = " . $delivery_id . " AND 
  employees.id = answer_paper_movement.he_have_id AND 
...
<div class="container" id="doc" style="width:700px">
  <main>
    ...
    <?php
      ...
      <p class="lead">نمودج تسليم اوراق اجابة للامتحان النهائي لمادة <?php echo $row["courseName"] ?></p>
    </div>
       ...
       <div class="col">
          ...
          <div class="row g-2 justify-content-center" style="margin:0 auto;">
            <div class="col-5" style="text-align:center;padding:0">
              <label for="firstName" class="form-label">الاستاد المستلم : <?php echo $row["name"] ?></label>
            </div> 
          </div>

          <div class="row g-2 justify-content-center" style="margin:0 auto;">
          <div class="col-4" style="text-align:center;padding:0">
                <label for="firstName" class="form-label">تاريخ التسليم (<?php echo $row["date"] ?>)</label>            
            </div>
          ...
          <div class="row" style="margin:10px 80px 10px 10px;">
           ...
           تم الاستلام من <?php echo $name_he_had ?>
