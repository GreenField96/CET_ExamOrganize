...
public class answerPaperMovementModel{
    ...
    public void store(){
        ...
        try {
            ...
            String query = "INSERT INTO answer_paper_movement (`committe_id`,`he_had_id`,`he_have_id`,`date`,`number_papers_received`,`group`) VALUES ( ?,  ? , ? , ? , ? , ? ) ";
            ...
            for (answerPaperMovementTable paper : papers) {
                ...
                statement.setString(6, paper.getGroupCol());
                statement.addBatch();
            }
