...
public class answerPaperMovementTable {
    ...
    public answerPaperMovementTable(int idCol,int committeIdCol, int heHadCol , int heHaveCol, String dateCol, String numberPaperRecivedCol,String specificCol, String groupCol) {
        this.idCol = idCol;
        this.committeIdCol = committeIdCol;
        this.heHadCol = heHadCol;
        this.heHaveCol = heHaveCol;
    ...
    public void setNumberPaperRecivedCol(String numberPaperRecivedCol) {this.numberPaperRecivedCol = numberPaperRecivedCol;}
